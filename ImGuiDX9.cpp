...
#include <imgui_custom/imgui_freetype.h>
...
static void ImGui_ImplDX9_CreateFontsTexture()
{
	...
	// Use FreeType library to generate font atlas
	if (io.Fonts->TexPixelsAlpha8 == nullptr)
	{
		...
		pixels = io.Fonts->TexPixelsAlpha8;
		bytes_per_pixel = 1;
		width = io.Fonts->TexWidth;
		height = io.Fonts->TexHeight;
	}
