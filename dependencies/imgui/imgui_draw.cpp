...
// Exported using binary_to_compressed_c.cpp
const unsigned int droidsans_ttf_compressed_size = 134345;
const unsigned int droidsans_ttf_compressed_data[134348/4] =
{
...
{
	return droidsans_ttf_compressed_size;
}

const unsigned int* GetDroidSansCompressedData()
{
	return droidsans_ttf_compressed_data;
}
