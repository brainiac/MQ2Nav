...
enum WLDObjectType : uint32_t
{
	...
	WLD_OBJ_2DSPRITEDEFINITION_TYPE           = 6,
	WLD_OBJ_2DSPRITEINSTANCE_TYPE             = 7,
	WLD_OBJ_3DSPRITEDEFINITION_TYPE           = 8,
	WLD_OBJ_3DSPRITEINSTANCE_TYPE             = 9,
	WLD_OBJ_4DSPRITEDEFINITION_TYPE           = 10, // (0x0A) - unused
	WLD_OBJ_4DSPRITEINSTANCE_TYPE             = 11, // (0x0B) - unused
	WLD_OBJ_PARTICLESPRITEDEFINITION_TYPE     = 12, // (0x0C) - unused
	WLD_OBJ_PARTICLESPRITEINSTANCE_TYPE       = 13, // (0x0D) - unused
	WLD_OBJ_COMPOSITESPRITEDEFINITION_TYPE    = 14, // (0x0E) - unused
	WLD_OBJ_COMPOSITESPRITEINSTANCE_TYPE      = 15, // (0x0F) - unused
	...
	WLD_OBJ_SPHEREVOLUME_TYPE                 = 22, // (0x16) - unused
	WLD_OBJ_POLYHEDRONDEFINITION_TYPE         = 23, // (0x17)
	WLD_OBJ_POLYHEDRONINSTANCE_TYPE           = 24, // (0x18)
	WLD_OBJ_SPHERELISTDEFINITION_TYPE         = 25, // (0x19) - unused
	WLD_OBJ_SPHERELISTINSTANCE_TYPE           = 26, // (0x1A) - unused
	WLD_OBJ_LIGHTDEFINITION_TYPE              = 27, // (0x1B)
	WLD_OBJ_LIGHTINSTANCE_TYPE                = 28, // (0x1C)
	WLD_OBJ_POINTLIGHT_OLD_TYPE               = 29, // (0x1D) - unused
	WLD_OBJ_WAVINFO_TYPE                      = 30, // (0x1E) - unused
	WLD_OBJ_SOUNDDEFINITION_TYPE              = 31, // (0x1F) - unused
	WLD_OBJ_SOUNDINSTANCE_TYPE                = 32, // (0x20) - unused
	WLD_OBJ_WORLDTREE_TYPE                    = 33, // (0x21)
	WLD_OBJ_REGION_TYPE                       = 34, // (0x22)
	WLD_OBJ_ACTIVEGEOMETRYREGION_TYPE         = 35, // (0x23) - unused
	WLD_OBJ_SKYREGION_TYPE                    = 36, // (0x24) - unused
	WLD_OBJ_DIRECTIONALLIGHT_OLD_TYPE         = 37, // (0x25) - unused
	WLD_OBJ_BLITSPRITEDEFINITION_TYPE         = 38, // (0x26)
	WLD_OBJ_BLITSPRITEINSTANCE_TYPE           = 39, // (0x27)
	WLD_OBJ_POINTLIGHT_TYPE                   = 40, // (0x28)
	WLD_OBJ_ZONE_TYPE                         = 41, // (0x29) - unused
	WLD_OBJ_AMBIENTLIGHT_TYPE                 = 42, // (0x2A) - unused
	WLD_OBJ_DIRECTIONALLIGHT_TYPE             = 43, // (0x2B) - unused
	WLD_OBJ_DMSPRITEDEFINITION_TYPE           = 44, // (0x2C)
	WLD_OBJ_DMSPRITEINSTANCE_TYPE             = 45, // (0x2D)
	WLD_OBJ_DMTRACKDEFINITION_TYPE            = 46, // (0x2E) - unused
	WLD_OBJ_DMTRACKINSTANCE_TYPE              = 47, // (0x2F) - unused
	...
	WLD_OBJ_DMTRACKDEFINITION2_TYPE           = 55, // (0x37) - unused
...
// flags for polyhedron instances
enum WLDOBJ_POLYOPT
{
	WLD_OBJ_POLYOPT_HAVESCALEFACTOR                  = 0x0001,
	WLD_OBJ_POLYOPT_HAVEFACENORMALS                  = 0x0002,
};
...
struct WODL_OBJ_POLYHEDRONDEFINITION
{
	int tag;
	uint32_t flags;
	uint32_t num_vertices;
...
struct WLD_OBJ_POLYHEDRONINSTANCE
{
	int tag;
	int definition_id;
	uint32_t flags;
