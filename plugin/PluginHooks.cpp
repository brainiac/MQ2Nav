...
#else
	//E8 ? ? ? ? A1 ? ? ? ? C7 80 ? ? ? ? ? ? ? ?
	//55 8B EC 6A FF 68 ? ? ? ? 64 A1 ? ? ? ? 50 64 89 25 ? ? ? ? 83 EC 10 53 56 57 8B 3D ? ? ? ? 8B F1 89 7D E4 C7 45 ? ? ? ? ? C7 45 ? ? ? ? ? 85 FF 74 27 8B 47 58 68 ? ? ? ?
	{
		"xxxxxx????xx????xxxx????xxxxxxxx????xxxxxxx?????xx?????xxxxxxxx????",
		(const unsigned char*)"",
		0x10000000, 0x10500000,
	},
